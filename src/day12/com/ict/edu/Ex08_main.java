...
public class Ex08_main {
	...
	public static void main(String[] args) {
		...
		Ex08_Constructor ion = new Ex08_Constructor("이온음료", 1000);
		Ex08_Constructor coke = new Ex08_Constructor("탄산음료", 1000);
		Ex08_Constructor juice = new Ex08_Constructor("과일음료", 1000);
		
		
		Ex08_Constructor [] arr = { coffee, ion, coke, juice };
