...
public class Ex02_File {
	...
	public static void main(String[] args) {
		String pathname = "D:/ystt/exam01.txt";
		...
		try {
			...
			File file2 = new File("D:/ystt/EXAM/AAA");
			...
			if (res2) {
				...
				System.out.println("디렉토리 생성 실패(기존 같은 이름의 디렉토리가 존재");
			}
			System.out.println("============================");
			
			//파일 삭제
			pathname = "D:/ystt/exam01.txt";
			...
			//디렉토리 삭제
			File file4 = new File("D:/ystt/EXAM/AAA");
			boolean res4 = file4.delete();
			if(res3) {
				System.out.println("디렉토리 AAA 삭제 성공");
				File file5 = new File("D:/ystt/EXAM");
