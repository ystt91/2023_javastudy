	...
	public Ex05_Dialog() {
		...
		jb1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(jp, "방가방가", "MESSAGE 창", JOptionPane.ERROR_MESSAGE);
		...
		jb2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				// int res = JOptionPane.showConfirmDialog(jp, "정말 삭제할까?");
				// System.out.println(res);

				// JOptionPane.showConfirmDialog(parentComponent, message, title, optionType);
				// optionType : YES_NO_CANCEL_OPTION(예, 아니오, 취소), YES_NO_CANCEL_OPTION(예, 아니오,
				// 취소),
				// OK_CANCEL_OPTION(확인, 취소)
				JOptionPane.showConfirmDialog(jp, "정말 삭제할까?", "확인창", JOptionPane.OK_CANCEL_OPTION);
			}
		});
...
//				System.out.println(res);
				...
				int res = JOptionPane.showInternalOptionDialog(jp, "방가방가", "사용자 다이얼 로그", JOptionPane.OK_CANCEL_OPTION,
